...
<div class="admin-card mb-4">
    ...
    <!-- Nút Sửa phòng được làm đẹp -->
    <div style="padding: 0 24px 24px 24px;">
        <button class="btn btn-edit-room w-100" onclick="openEditRoomModal()">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p style="color:var(--text-muted); font-size:13px; margin-bottom:20px">
                    Nhập số điện thoại của người dùng cần thêm vào phòng <strong
                        style="color:var(--text-primary)">${room.name}</strong>.
                </p>
                <div>
...
<div class="modal fade" id="editRoomModal" tabindex="-1">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="bi bi-pencil me-2" style="color:#ffc107"></i>Sửa thông tin phòng
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
            </div>
            <div class="modal-body">
            ...
            <div class="modal-footer">
                ...
                <button onclick="submitEditRoom()"
                        style="background:#ffc107;color:#000;border:none;border-radius:9px;padding:9px 20px;font-weight:600;cursor:pointer">
...
<script>
        ...
        fetch((window.__CTX || '') + '/api/admin/rooms/' + ROOM_ID + '/members', {
            ...
            .then(res => {
                if (!res.ok) return res.text().then(t => {
                    throw new Error(t || 'Lỗi thêm thành viên');
                });
                return res.json();
            })
            .then(member => {
    ...
    function openEditRoomModal() {
        if (!editModal) editModal = new bootstrap.Modal(document.getElementById('editRoomModal'));
        editModal.show();
    }
